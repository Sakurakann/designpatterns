...
public class UserStrategy {
  ...
  public static void main(String[] args) {
    ...
    Icalculator plusCalc = new Plus();
    Icalculator minusCalc = new Minus();

    System.out.println(plusCalc.calculare(plusExp));
    System.out.println(minusCalc.calculare(minusExp));
  }
